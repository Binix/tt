(function () {
    ...
    module.exports = {
        ...
        afterLogIn: function (src, defaultChan) {
            ...
            displayBot("WelcomeBot", "Hey, <b><font color='" + Utils.nameColor(src) + "'>" + srcname + "</font></b>!", "purple");
            displayBot("CommandBot", "Type <b>/commands</b> for a list of commands and <b>/rules</b> for a list of rules.");
            ...
            if (typeof startUpTime === "number" && startUpTime < sys.time()) {
                displayBot("CaloBot", "The server has been up for " + Utils.fancyJoin(Utils.uptime()) + ".", "orange");
            }
